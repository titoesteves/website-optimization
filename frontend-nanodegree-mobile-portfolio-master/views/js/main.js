...
var resizePizzas = function(size) { 
  ...
  //Modified function to no longer have to change from percentage
...
function updatePositions() {
  ...
  //moved this outside of for loop to prevent forced sync layout
  var j = items[i].basicLeft;
  for (i; i < items.length; i++) {
    var phase = Math.sin((document.body.scrollTop / 1250) + (i % 5));
    items[i].style.left = j + 100 * phase + 'px';
  }
